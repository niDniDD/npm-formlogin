...
class HideWhen {
    ...
    static get style() { return ".sc-ion-hide-when-h{display:block}.hide-content.sc-ion-hide-when-h{display:none}"; }
}
...
class ShowWhen {
    ...
    static get style() { return ".sc-ion-show-when-h{display:none}.show-content.sc-ion-show-when-h{display:block}"; }
}
